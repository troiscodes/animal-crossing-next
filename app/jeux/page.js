                ...
                <div className="relative text-2xl ml-6 mr-6 pt-4 pl-6 pr-6 flex md:w-full md:min-h-[357px] rounded-3xl" style={{ backgroundColor: 'rgba(111, 238, 40, 0.3)' }}>
                    <div className="grid md:grid-cols-7">
                        ...
                        <div className=" md:col-span-1">
                            <Image src="/jeu-gamecube-image.png" width={350} height={100} className="md:absolute bottom-0 right-0" />
                        </div>
                    </div>
                </div>
                </div>
            ...
            <section className="flex items-center md:pt-8" id="ds">
                ...
                <div className="relative text-2xl ml-6 mr-6 pt-4 pl-6 pr-6 flex md:w-full md:min-h-[357px] rounded-3xl" style={{ backgroundColor: 'rgba(111, 238, 40, 0.3)' }}>
                    <div className="grid md:grid-cols-7">
                        ...
                        <div className=" md:col-span-1">
                            <Image src="/jeu-ds-image.png" width={350} height={100} className="md:absolute bottom-0 right-0" />
                        </div>
                    </div>
                </div>
                </div>
            ...
            <section className="flex items-center md:pt-8" id="wii">
                ...
                <div className="relative text-2xl ml-6 mr-6 pt-4 pl-6 pr-6 flex md:w-full md:min-h-[357px] rounded-3xl" style={{ backgroundColor: 'rgba(111, 238, 40, 0.3)' }}>
                    <div className="grid md:grid-cols-7">
                        ...
                        <div className=" md:col-span-1">
                            <Image src="/jeu-wii-image.png" width={350} height={100} className="md:absolute bottom-0 right-0" />
                        </div>
                    </div>
                </div>
                </div>
            ...
            <section className="flex items-center md:pt-8" id="3ds">
                ...
                <div className="relative text-2xl ml-6 mr-6 pt-4 pl-6 pr-6 flex md:w-full md:min-h-[357px] rounded-3xl" style={{ backgroundColor: 'rgba(111, 238, 40, 0.3)' }}>
                    <div className="grid md:grid-cols-7">
                        ...
                        <div className=" md:col-span-1">
                            <Image src="/jeu-3ds-image.png" width={350} height={100} className="md:absolute bottom-0 right-0" />
                        </div>
                    </div>
                </div>
                </div>
            ...
            <section className="flex items-center md:pt-8" id="switch">
                ...
                <div className="relative text-2xl ml-6 mr-6 pt-4 pl-6 pr-6 flex md:w-full md:min-h-[357px] rounded-3xl" style={{ backgroundColor: 'rgba(111, 238, 40, 0.3)' }}>
                    <div className="grid md:grid-cols-7">
                        ...
                        <div className=" md:col-span-1">
                            <Image src="/jeu-switch-image.png" width={350} height={100} className="md:absolute bottom-0 right-0" />
                        </div>
                    </div>
                </div>
                </div>
