    ...
    return (
      ...
      style={{ backgroundImage: "url('/background_section_characters.jpeg')" }}>
                ...
                <div className="md:h-[1579px] h-[4000px] w-full grid md:grid-cols-3 md:grid-rows-3 grid-cols-1 gap-5 my-14">
                    ...
                    <div className="rounded-2xl h-[400px] w-[300px] self-center place-self-center drop-shadow-xl flex items-center justify-center md:mb-5 transition-transform ease-in-out hover:scale-125"><a href="/personnages"><img src="Rounard_card.png" alt="Rounard" className="h-[365px] w-[260px] rounded-2xl"/></a></div>
                    <div className="rounded-2xl h-[400px] w-[300px] self-center place-self-center drop-shadow-xl flex items-center justify-center md:mb-5 transition-transform ease-in-out hover:scale-125"><a href="/personnages"><img src="Layette_card.png" alt="Layette" className="h-[365px] w-[260px] rounded-2xl"/></a></div>
                    <div className="rounded-2xl h-[400px] w-[300px] self-center place-self-center drop-shadow-xl flex items-center justify-center md:mb-5 transition-transform ease-in-out hover:scale-125"><a href="/personnages"><img src="Porcelette_card.jpg" alt="Porcelette" className="h-[365px] w-[260px] rounded-2xl"/></a></div>
                    <div className="rounded-2xl h-[400px] w-[300px] self-end place-self-center drop-shadow-xl flex items-center justify-center md:m-5 transition-transform ease-in-out hover:scale-125"><a href="/personnages"><img src="KK_card.jpg" alt="KK" className="h-[365px] w-[260px] rounded-2xl"/></a></div>
                    <div className="rounded-2xl h-[400px] w-[300px] self-end place-self-center drop-shadow-xl flex items-center justify-center md:m-5 transition-transform ease-in-out hover:scale-125"><a href="/personnages"><img src="Marie_card.png" alt="Marie" className="h-[365px] w-[260px] rounded-2xl"/></a></div>
